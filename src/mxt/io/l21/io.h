...
static inline bool gpio_is_valid(const uint8_t pin)
{
	return !!pin;
}

static inline bool gpio_request(const uint8_t pin, const char * name)
{
	return true;
}

static inline int gpio_to_irq(const uint8_t pin)
{
	return pin;
}
