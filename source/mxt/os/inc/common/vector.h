...
struct vector{
	...
	vector_iterator (*push_back)(struct vector *, vector_element);
	vector_iterator (*push_front)(struct vector *, vector_element);
...
static inline vector_iterator vector_push_front(struct vector *vec, vector_element val)
{	
...
static inline vector_iterator vector_push_back(struct vector *vec, vector_element val)
{
