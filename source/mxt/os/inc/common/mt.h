...
static inline int input_mt_init_slots(struct input_dev *dev, int num_slots,
			unsigned int flags)
{
	//dummy
...
static inline void input_mt_destroy_slots(struct input_dev *dev)
{
	//dummy
}
...
static inline void input_mt_report_slot_state(struct input_dev *dev,
				int tool_type, bool active)
{
	//dummy
}

static inline void input_mt_report_finger_count(struct input_dev *dev, int count)
{
	//dummy
}
static inline void input_mt_report_pointer_emulation(struct input_dev *dev, bool use_count)
{
	//dummy
}
